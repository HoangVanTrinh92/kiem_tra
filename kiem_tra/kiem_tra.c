    ...
    do{
        ...
        switch(c){
            ...
            case 2:
                ...
                printf("Tong so cung co trong do thi la: %d\n",i/2);
            break;       
            case 3 :
                ...
                if(v==-1){
                    ...
                    n=out(g, v, output);
                    if(n==0){
                        printf("Khong co dinh nao lien thong voi dinh \'%s\'.\n",name);
                        break;
                    }else{
                        printf("So luong dinh lien thong voi dinh \'%s\' la: %d.\n",name,n);
            ...
            case 4 :
                ...
                printf("Danh sach cac nut co lien thong lon nhat la: \n");
                jrb_traverse(node,g.dinh){
                    v=jval_i(node->key);
                    output=(int*)malloc(sizeof(int)*MAX);
                    n=out(g,v,output);
                    if(n==max) printf("%s\t",laytendinh(g,v));

                }
                printf("\n");
            break;
            case 5:
                printf("Danh sach cac nut la nut dao la: \n");
                jrb_traverse(node,g.dinh){
                    v=jval_i(node->key);
                    output=(int*)malloc(sizeof(int)*MAX);
                    n=out(g,v,output);
                    if(n==0) printf("%s\t",laytendinh(g,v));
                }
                printf("\n");
            break;      
            case 6 :
            ...
            case 7:
                ...
                b=duongdi(g,v1,v2);
                if(b->total==0) printf("Khong co dung di tu dinh \'%s\' den dinh \'%s\'.\n",name,name2);
                else{
                    printf("So luong duong di tu dinh \'%s\' den dinh \'%s\' la: %d.\n",name,name2,b->total);
...
int menu(){
    ...
    char s[100];
    printf("\n**********************MENU*************************************************\n");
    printf("1.Doc ma tran bat quai.\n2.Tong so nut va tong so cung.\n3.Cac dinh co lien thong voi mot dinh.");
    printf("\n4.Danh sac cac nut co lien thong lon nhat.\n5.Danh sach cac nut dao.\n6.Duong di ngan nhat giua hai nut.\n");
    printf("7.Tat ca duong di giua hai nut.\n8.Thoat.\n");
   printf("***************************************************************************\n");
   do{
